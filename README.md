...
```bash
git clone [https://github.com/](https://github.com/sonwanejay/movieapp)
```
...
The app will start running, and you can open it in your browser at `http://localhost:5173` [localhost](http://localhost:5173)
